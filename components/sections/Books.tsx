...
export function Books({ userProgress }: { userProgress?: Progress[] }) {
    return (
        <section className="py-24 relative">
            <Container>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                    {books.map((book, i) => {
                        const progress = userProgress?.find((p) => p.book_id === book.slug);
                                ...
                                <GlowCard delay={i * 0.1} className="p-0">
                                    <div className="relative aspect-[3/4] w-full overflow-hidden">
                                        ...
                                        <div className="absolute bottom-0 left-0 right-0 p-6">
                                            ...
                                            {progress && (
                                                <p className="text-xs text-dustyRose/80 mb-2">
                                                    Читаете: глава {progress.chapter} из {progress.totalChapters}, {progress.percent}%
                                                </p>
                                            )}
